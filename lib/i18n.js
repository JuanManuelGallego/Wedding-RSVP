...
export const translations = {
  es: {
    ...
    alreadyRespondedYes: 'Ya confirmaste tu asistencia. ¿Deseas cambiar tu respuesta?',
    alreadyRespondedNo: 'Ya confirmaste que no podrás asistir. ¿Deseas cambiar tu respuesta?',
