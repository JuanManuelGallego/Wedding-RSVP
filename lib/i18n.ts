...
export const translations: Record<Locale, Record<string, string>> = {
  es: {
    ...
    invitedEyebrowParty: 'Tienen una invitación',
    hm: 'Ups',
    notFound:
  ...
  fr: {
    ...
    invitedEyebrowParty: 'Vous êtes invités',
    hm: 'Oups',
    notFound:
    ...
    alreadyRespondedYes:
      'Vous avez confirmé votre présence. Souhaitez-vous modifier votre réponse ?',
    alreadyRespondedNo:
      "Vous avez confirmé que vous ne pourrez pas assister. Souhaitez-vous modifier votre réponse ?",
